...
TerraTactics.scene.MainMenu.prototype.init = function () {
    ...
    this.m_instructions = new rune.display.Sprite(160, 125, 96, 96, "gameRules");
    this.m_exitGame = new rune.display.Sprite(160, 175, 96, 96, "ExitGame");

    this.m_playGame.animation.create("idle", [0], 1, true);
    this.m_credits.animation.create("idle", [0], 1, true);
    ...
    this.m_credits.animation.create("selected", [1, 2], 6, true);
    ...
    this.stage.addChild(this.m_credits);
...
TerraTactics.scene.MainMenu.prototype.update = function (step) {
    ...
    if (this.m_player1Controls.confirmHeld || this.m_player2Controls.confirmHeld) {
        ...
        if (this.m_selectedIndex === 1) {
            this.application.scenes.load([new TerraTactics.scene.CreditsMenu()]);
        }
